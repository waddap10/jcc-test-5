...
import { ArrowLeft, Check, Trash, ImageIcon } from 'lucide-react';
...
export default function OrderShow() {
    ...
    const handleAccKanit = () => {
        if (confirm(`Acc Kanit for #${order.id}?`)) {
            patch(route('sales.orders.acc-kanit', order.id));
        }
    };
        ...
        <span>{order.discount}%</span>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <div className='flex items-center gap-2'>
                            <Link href={route('sales.orders.schedules.create', order.id)}>
                                <Button variant="outline" size="sm">
                                    Add Schedule
                                </Button>
                            </Link>
                            {order.schedules?.length > 0 ? (
                                <Link href={route('sales.orders.schedules.edit', order.id)}>
                                    <Button variant="outline" size="sm">
                                        Edit Schedule
                                    </Button>
                                </Link>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Link href={route('sales.orders.beos.create', order.id)}>
                            <Button variant="outline" size="sm">
                                Add BEO
                            </Button>
                        </Link>
                        {order.beos?.length > 0 && (
                            <Link href={route('sales.orders.beos.edit', order.id)}>
                                <Button variant="outline" size="sm">
                                    Edit BEOs
                                </Button>
                            </Link>
            ...
            <div className="xl:col-span-2">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Link href={route('sales.orders.attachments.create', order.id)}>
                                <Button variant="outline" size="sm">
                                    Upload Images
                                </Button>
                            </Link>
                            {getImageAttachments(order.attachments).length > 0 && (
                                <Link href={route('sales.orders.attachments.edit', order.id)}>
                                    <Button variant="outline" size="sm">
                                        Manage Images
                                    </Button>
                                </Link>
